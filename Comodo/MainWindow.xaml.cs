...
namespace Comodo
{
    public partial class MainWindow : Window
    {
        ...
        void Tick()
        {
            ...
            double velCam = dt / 5.0;
            tCamera += (indo ? +velCam : -velCam);
            if (tCamera >= 1) { tCamera = 1; indo = false; }
            if (tCamera <= 0) { tCamera = 0; indo = true; }
            AtualizarCamera();
            tLuz += dt / 10.0;
        ...
        void AtualizarCamera()
        {
            ...
            camera.Position = pos;
            camera.LookDirection = (Vector3D)(centroCasa - pos);
        ...
        static Material PedraRepetida(string caminhoRelativo, int repeticoesPorLado = 12)
        {
            ...
            double s = 1.0 / Math.Max(1, repeticoesPorLado);
        ...
        static MeshGeometry3D CriarTelhado(double comp, double prof, double yBase, double yCumeeira)
        {
            ...
            Tri(a0, a1, a2); Tri(a0, a2, a3);
            Tri(b0, b3, b2); Tri(b0, b2, b1);
